...
public class PropertyUtil implements ApplicationContextInitializer<ConfigurableApplicationContext> {
    ...
    private static String jdbcDriverName = MYSQL_JDBC_DRIVER_NAME;
    ...
    public static void setJdbcDriverName(String jdbcDriverName) {
        PropertyUtil.jdbcDriverName = jdbcDriverName;
    }
    ...
    private void loadSetting() {
        try {
            ...
            String dbPlatform = getString(PropertiesConstant.SPRING_DATASOURCE_PLATFORM, "");
            boolean useExternalStorage = PropertiesConstant.MYSQL.equalsIgnoreCase(dbPlatform) || PropertiesConstant.DM.equalsIgnoreCase(dbPlatform);
            setUseExternalDB(useExternalStorage);

            if (PropertiesConstant.MYSQL
                    .equalsIgnoreCase(getString(PropertiesConstant.SPRING_DATASOURCE_PLATFORM, ""))) {
                setJdbcDriverName(MYSQL_JDBC_DRIVER_NAME);
            }
            if (PropertiesConstant.DM
                    .equalsIgnoreCase(getString(PropertiesConstant.SPRING_DATASOURCE_PLATFORM, ""))) {
                setJdbcDriverName(DM_JDBC_DRIVER_NAME);
            }
